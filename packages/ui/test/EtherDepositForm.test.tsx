...
describe("Rollups EtherDepositForm", () => {
    ...
    describe("Amount input", () => {
        ...
        it("should display the connected account's balance", async () => {
            render(
                <Component {...defaultProps} applications={[selectedApp]} />,
            );
        ...
        it("should fill the amount input when clicking the max button", async () => {
            render(
                <Component {...defaultProps} applications={[selectedApp]} />,
            );
        ...
        it("should not display the max option when the balance is zero", async () => {
            useBalanceMock.mockReturnValue({
                data: {
                    value: 0n,
                    decimals: 18,
        ...
        it("should display error message when amount exceeds the balance", async () => {
            render(
                <Component {...defaultProps} applications={[selectedApp]} />,
            );
            await setRequiredValueToOpenForm(selectedApp);
            ...
            expect(
                screen.getByText(
                    "The amount 10 exceeds your current balance of 0.456632268985698099 ETH",
                ),
            ).toBeVisible();
        });
