        ...
        describe("For ABI Parameters", () => {
            ...
            describe("AbiTypes delegated checks", () => {
                it("should display error message when invalid abi type is used", async () => {
                    ...
                    expect(
                        screen.getByText(
                            `Unknown type. Type "bla" is not a valid ABI type. Version: abitype@1.2.3`,
                        ),
                    ).toBeInTheDocument();
                });
                ...
                it("should display error message when using reserved word as variable name", async () => {
                    ...
                    expect(
                        screen.getByText(
                            `Invalid ABI parameter. "address" is a protected Solidity keyword. More info: https://docs.soliditylang.org/en/latest/cheatsheet.html Details: uint address Version: abitype@1.2.3`,
                        ),
                    ).toBeInTheDocument();
                });
            });
