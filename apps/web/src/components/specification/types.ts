...
export const equalityOperators = ["equals"] as const;
...
export type Operator = (typeof equalityOperators)[number];
...
export type AbiParamsSpec = Commons & {
    mode: "abi_params";
