...
import type { QueryValue } from "../../helpers";

const sybilClaims = range(50, 58).map((value) => claim(value).hash);
const claimsCopy = Array.from(sybilClaims);
const sybilMatches = range(0, 4).map(() => {
    const sybilCommitmentOne = claimsCopy.shift() as Hex;
    const sybilCommitmentTwo = claimsCopy.shift() as Hex;
    const matchIdHash = generateMatchID(sybilCommitmentOne, sybilCommitmentTwo);

    return {
        epochIndex: "$bigint:0",
        tournamentAddress: "0x61bCAb9d0D8b554009824292d2d6855DfA3AAB86",
        idHash: matchIdHash,
        commitmentOne: sybilCommitmentOne,
        commitmentTwo: sybilCommitmentTwo,
        leftOfTwo:
        ...
        createdAt: "2026-01-16T09:43:10.953Z",
        updatedAt: "2026-01-16T09:43:10.979Z",
    };
});

const sybilCommitments = sybilClaims.map((claim, index) => {
    const fakeSubmitterAddress = getAddress(
        generateTournamentAddress(index, index + 1),
    );
    return {
        epochIndex: "$bigint:0",
        tournamentAddress: "0x61bCAb9d0D8b554009824292d2d6855DfA3AAB86",
        ...
        submitterAddress: fakeSubmitterAddress,
        blockNumber: "$bigint:1133",
        txHash: "0x06ad8f0ce427010498fbb2388b432f6d578e4e1ffe5dbf20869629b09dcf0d70",
        createdAt: "2026-01-16T09:43:10.952Z",
        updatedAt: "2026-01-16T09:43:10.952Z",
    };
});

/**
 * Extra query information related to each match information
 * e.g. hierarchy (breadcrumbs), advances, other sub-tournaments
 */
const sybilMatchSupportQueries: QueryValue[] = [];

sybilMatches.forEach((sybilMatch) => {
    const matchQuery = {
        queryKey: [
            "match",
            {
                application: "AppFifteen",
                epochIndex: "0",
                tournamentAddress: "0x61bCAb9d0D8b554009824292d2d6855DfA3AAB86",
                idHash: sybilMatch.idHash,
            },
        ],
        data: sybilMatch,
    };

    const matchAdvanceQuery = {
        queryKey: [
            "matchAdvances",
            {
                application: "AppFifteen",
    ...
    const innerTournamentQuery = {
        queryKey: [
            "tournaments",
            {
                ...
                parentMatchIdHash: sybilMatch.idHash,
            },
        ],
        data: {
            data: [],
    ...
    sybilMatchSupportQueries.push(
        matchQuery,
        matchAdvanceQuery,
        innerTournamentQuery,
    );
});
...
const queries = [
            ...
            data: [
                {
                    ...
                    createdAt: "2026-01-16T09:43:02.730Z",
                    updatedAt: "2026-01-16T09:43:11.012Z",
                },
            ],
            pagination: {
                limit: 50,
            ...
            data: [
                {
                    ...
                    createdAt: "2026-01-16T09:43:02.730Z",
                    updatedAt: "2026-01-16T09:43:04.884Z",
                },
                {
                    epochIndex: "$bigint:0",
                    index: "$bigint:1",
                    ...
                    createdAt: "2026-01-16T09:43:02.730Z",
                    updatedAt: "2026-01-16T09:43:04.876Z",
                },
                {
                    epochIndex: "$bigint:0",
                    index: "$bigint:0",
                    ...
                    createdAt: "2026-01-16T09:43:02.730Z",
                    updatedAt: "2026-01-16T09:43:04.867Z",
                },
            ],
            pagination: {
                limit: 50,
    ...
    },
    {
        ...
        data: {
            ...
            createdAt: "2026-01-16T09:43:10.950Z",
            updatedAt: "2026-01-16T09:43:10.950Z",
        },
    },
    {
        queryKey: [
            ...
            data: [
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.953Z",
                    updatedAt: "2026-01-16T09:43:10.953Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                    ...
                    createdAt: "2026-01-16T09:43:10.954Z",
                    updatedAt: "2026-01-16T09:43:10.954Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.955Z",
                    updatedAt: "2026-01-16T09:43:10.955Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.956Z",
                    updatedAt: "2026-01-16T09:43:10.956Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.957Z",
                    updatedAt: "2026-01-16T09:43:10.957Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.958Z",
                    updatedAt: "2026-01-16T09:43:10.958Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                    ...
                    createdAt: "2026-01-16T09:43:10.959Z",
                    updatedAt: "2026-01-16T09:43:10.959Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.960Z",
                    updatedAt: "2026-01-16T09:43:10.960Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.961Z",
                    updatedAt: "2026-01-16T09:43:10.961Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                    ...
                    createdAt: "2026-01-16T09:43:10.962Z",
                    updatedAt: "2026-01-16T09:43:10.962Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.963Z",
                    updatedAt: "2026-01-16T09:43:10.963Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                    ...
                    createdAt: "2026-01-16T09:43:10.964Z",
                    updatedAt: "2026-01-16T09:43:10.964Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.965Z",
                    updatedAt: "2026-01-16T09:43:10.965Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.966Z",
                    updatedAt: "2026-01-16T09:43:10.966Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.967Z",
                    updatedAt: "2026-01-16T09:43:10.967Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.968Z",
                    updatedAt: "2026-01-16T09:43:10.968Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.969Z",
                    updatedAt: "2026-01-16T09:43:10.969Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.970Z",
                    updatedAt: "2026-01-16T09:43:10.970Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.971Z",
                    updatedAt: "2026-01-16T09:43:10.971Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.972Z",
                    updatedAt: "2026-01-16T09:43:10.972Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                    ...
                    createdAt: "2026-01-16T09:43:10.973Z",
                    updatedAt: "2026-01-16T09:43:10.973Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.974Z",
                    updatedAt: "2026-01-16T09:43:10.974Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.975Z",
                    updatedAt: "2026-01-16T09:43:10.975Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.976Z",
                    updatedAt: "2026-01-16T09:43:10.976Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
                ...
                },
                {
                    ...
                    createdAt: "2026-01-16T09:43:10.977Z",
                    updatedAt: "2026-01-16T09:43:10.977Z",
                },
                {
                    epochIndex: "$bigint:0",
                    tournamentAddress:
