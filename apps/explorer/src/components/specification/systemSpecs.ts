            ...
            conditions: [
                {
                    ...
                    operator: "equals",
                    value: erc1155SinglePortalConfig.address,
                },
            ],
        },
    ],
            ...
            conditions: [
                {
                    field: "decodedData.sender",
                    operator: "equals",
                    value: erc1155BatchPortalConfig.address,
                },
            ],
        },
    ],
            ...
            conditions: [
                {
                    field: "decodedData.sender",
                    operator: "equals",
                    value: erc20PortalConfig.address,
                },
            ],
        },
    ],
            ...
            conditions: [
                {
                    field: "decodedData.sender",
                    operator: "equals",
                    value: erc721PortalConfig.address,
                },
            ],
        },
    ],
            ...
            conditions: [
                {
                    field: "decodedData.sender",
                    operator: "equals",
                    value: etherPortalConfig.address,
                },
            ],
        },
    ],
